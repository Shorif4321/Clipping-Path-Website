        ...
        <div>
            ...
            <section className='help-selection py-5'>
                <div className='container d-flex left-right-main'>
                    <div className='col-lg-7 col-md-11 m-auto col-11 form-left'>
                        ...
                        {/* ==== input start==== */}
                        <div className='d-md-flex justify-content-between flex-wrap py-3'>

                            <div className='col-lg-3 col-md-6 col-11 mt-md-3'>
                                <div className="form-check mt-2">
                                    <input type="checkbox" className="form-check-input me-2" id="exampleCheck1" />
                                    <div className='text-start'>
                                        <label className="form-check-label" htmlFor="exampleCheck1"><small>Clipping Path</small> </label>
                                    </div>
                                </div>
                                <div className="form-check mt-2">
                                    <input type="checkbox" className="form-check-input me-2" id="exampleCheck2" />
                                    <div className='text-start'>
                                        <label className="form-check-label" htmlFor="exampleCheck2"> <small>Background Removal </small></label>
                                    </div>
                                </div>
                            </div>
                            <div className='col-lg-3 col-md-6 col-11 mt-md-3'>
                                <div className="form-check mt-2">
                                    <input type="checkbox" className="form-check-input me-2" id="exampleCheck3" />
                                    <div className='text-start'>
                                        <label className="form-check-label" htmlFor="exampleCheck3"> <small>Image Masking</small> </label>
                                    </div>
                                </div>
                                <div className="form-check mt-2">
                                    <input type="checkbox" className="form-check-input me-2" id="exampleCheck4" />
                                    <div className='text-start'>
                                        <label className="form-check-label" htmlFor="exampleCheck4"> <small>Color Correction</small></label>
                                    </div>
                                </div>
                            </div>
                            <div className='col-lg-3 col-md-6 col-11 mt-md-3'>
                                <div className="form-check mt-2">
                                    <input type="checkbox" className="form-check-input me-2" id="exampleCheck5" />
                                    <div className='text-start'>
                                        <label className="form-check-label" htmlFor="exampleCheck5"><small>Ghost Mannequin </small></label>
                                    </div>
                                </div>
                                <div className="form-check mt-2">
                                    <input type="checkbox" className="form-check-input me-2" id="exampleCheck6" />
                                    <div className='text-start'>
                                        <label className="form-check-label" htmlFor="exampleCheck6"><small>Photo Retouching</small></label>
                                    </div>
                                </div>
                            </div>
                            <div className='col-lg-3 col-md-6 col-11 mt-md-3'>
                                <div className="form-check mt-2">
                                    <input type="checkbox" className="form-check-input me-2" id="exampleCheck7" />
                                    <div className='text-start'>
                                        <label className="form-check-label" htmlFor="exampleCheck7"><small>Shadow Creation </small></label>
                                    </div>
                                </div>
                                <div className="form-check mt-2">
                                    <input type="checkbox" className="form-check-input me-2" id="exampleCheck8" />
                                    <div className='text-start'>
                                        <label className="form-check-label" htmlFor="exampleCheck8"><small>Others</small></label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className='output-filed'>
                            <h3 className='text-start fw-bold py-2 mt-3'>
                                What can we help you with? </h3>
                        ...
                        <div className='output-filed'>
                            ...
                            <div className='d-flex justify-content-between pe-lg-5 '>
                                <input className="form-control " type="text" placeholder='Give Your Link Here' aria-label=".form-control-lg example" />
                            </div>
                        </div>
                            ...
                            <div className=' pt-4 pe-lg-5 '>
                                <div className="row">
                                    <div className="col-12 col-md-6 text-start mb-3">
                                        <label htmlhtmlFor="" className='common-p pb-2'><small>Name *</small></label>
                                        <input type="text" className="form-control" aria-label="First name" />
                                    </div>
                                    <div className="col-12 col-md-6 text-start mb-3">
                                        <label htmlhtmlFor="" className='common-p pb-2'><small>Email *</small></label>
                                        <input type="email" className="form-control" aria-label="First name" />
                                    </div>
                                    <div className="col-12 col-md-6 text-start mb-3">
                                        <label htmlhtmlFor="" className='common-p pb-2'> <small>Phone</small> </label>
                                        <input type="number" className="form-control" min="0" aria-label="First name" />
                                    </div>
                                    <div className="col-12 col-md-6 text-start mb-3">
                                        <label htmlhtmlFor="" className='common-p pb-2'> <small>Website</small></label>
                                        <input type="text" className="form-control" aria-label="First name" />
                                    </div>
                                    <div className="col-12 text-start mb-3">
                                        <label htmlhtmlFor="" className='common-p pb-2'> <small>Message</small></label>
                                        <div className="">
